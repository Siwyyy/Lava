...
void SceneLayer::onAttach()
{
	...
	m_objects.push_back(std::make_shared<Lava::BasicBody3D>(x_arrow_vertices, x_arrow_indices, glm::vec3(0.f), x_arrow_rotation));
	...
	m_objects.push_back(std::make_shared<Lava::BasicBody3D>(z_arrow_vertices, z_arrow_indices, glm::vec3(0.f), z_arrow_rotation));

	// Camera
	m_camera = std::make_shared<Lava::Camera3D>(glm::vec3(-1.f, -1.f, 1.f));
